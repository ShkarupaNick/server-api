...
<div class="container">
    ...
    <div class="col-lg-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="page-header">Top comments</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-3">
                        <img class="img-responsive img-portfolio img-hover" src="img/lateshow242.jpg" alt="">
                    </div>
                    <div class="col-lg-9">
                        <div class="text-left">
                            <h4>Seran</h4>
                            <h5>You knew it was going to go down this way. While the Panthers were rolling through the
                                regular season on their way to the seventh 15-1 season in NFL history, the Seahawks were
                                heating up on the opposite coast, stringing together wins down the stretch.</h5>
                        </div>
                    </div>
                </div>
            </div>
