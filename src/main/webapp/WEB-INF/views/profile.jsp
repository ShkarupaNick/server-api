    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-10">
            <div class="panel panel-primary">
                ...
                <form:form method="POST" role="form" modelAttribute="userForm" enctype="multipart/form-data">

                    <div class="panel-body">
                        <div class="col-md-4 col-sm-4 col-md-4 separator login-box">
                            <h3 class="text-center"><b>Syma</b></h3>
                            <br/>
                            <a href="#">
                                <img class="media-object img-rounded img-profile"
                                ...
                                <span id="fileselector">
                                    <label class="btn btn-labeled pull-right img-input" for="upload-file-selector">
                                <form:input id="upload-file-selector" type="file" path="profilePictureFile"
                                            onchange="this.form.submit()"
                                            class="form-control" placeholder="Avatar" style="display:none"/>
                                       Browse
                                    </label>
                                </span>
                                </spring:bind>
                        ...
                        <div class="col-md-6 col-sm-6 col-md-6  social-login-box">
                            ...
                            <h6 class="text-left desc-text">This email is linked to your account.</h6>
                            ...
                            <form:errors path="newPassword" class="error-text"></form:errors>
                            ...
                            <h6 class="text-left desc-text">Fill these filds and press Apply to change your
                                password.</h6>
                            <br/>
                            <h3 class="text-left"><b>Connect social accounts</b></h3>
                            <br/>
                            <div class="col-md-6 col-sm-6 col-md-6  social-login-box">
                                ...
                                <br/>
                                <a href="#" class="btn twitter btn-block" role="button">Sign in with Twitter</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-7">
                                <button type="submit" class="btn btn-labeled pull-right">Apply</button>
                            </div>
                        </div>
                    </div>
                </form:form>
